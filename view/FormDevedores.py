...
class Ui_FormDevedores(object):
    ...
    def setupUi(self, FormDevedores):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../../img/contas a receber.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("../../img/pdf.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
